...
public class BabiesListAdapter extends RecyclerView.Adapter<BabiesListAdapter.MyViewHolder> {
    ...
    public BabiesListAdapter(ArrayList<String> mealNameList, ArrayList<String> mealImageList, ArrayList<Integer> mealIndexList, Context context) {
    ...
    @NonNull
    @Override
    public BabiesListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BabiesListAdapter.MyViewHolder holder, int position) {
